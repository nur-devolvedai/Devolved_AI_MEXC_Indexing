      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            <Link href="/">
              <samp className="flex items-center text-gray-700">
                ...
                <span className="ml-2 text-xl font-bold">Argochain</span>
              </samp>
            </Link>
          ...
          <div className="w-full md:w-1/3">
            ...
            <p className="text-sm">Email: support@polygonscan.com</p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-4 text-center">
          <p className="text-sm">&copy; 2024 Argochain. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
